...
const I18N = {
  ...
  "Ayushman Card KYC related project supporting field coordination and service delivery as per project requirements.":"आयुष्मान कार्ड KYC से संबंधित प्रोजेक्ट, जिसमें प्रोजेक्ट की आवश्यकताओं के अनुसार फील्ड समन्वय और सेवा कार्य किया जाता है।",
...
function cleanLegacyCustomerText(){
  ...
  if(Array.isArray(data.projects)){
    data.projects.forEach(p=>{
      if(p.description === "Ayushman Card KYC related project. Details can be updated from the Admin Panel when confirmed."){
        p.description = "Ayushman Card KYC related project supporting field coordination and service delivery as per project requirements.";
      }
    });
  }
}
