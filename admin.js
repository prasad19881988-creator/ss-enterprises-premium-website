...
function normalise(raw){
  ...
  /*
   * पुराने data में Hindi fields नहीं हैं तो
   * blank Hindi fields बना दिए जाएंगे।
   */
...
function addHindiFields(){
  ...
  s.services.cards =
    Array.isArray(s.services.cards)
      ? s.services.cards
      : [];
...
function renderProjects(){
  ...
  $("projectForms").innerHTML =
    ...
    <article
      class="admin-card project-admin-row"
    ...
    >
      ...
      <div class="row-head">
        ...
        <div class="row-actions">
          ...
          ${
            p.status==="upcoming"
              ? `<button class="mini-btn live-project">
                   Live / Active
                 </button>`
              : ""
          }
          ...
          <button class="mini-btn danger delete-project">
            Delete
          </button>
      ...
      <div class="form-grid">
        ...
        <label>
          ...
          <input
            data-project-hi="department"
            value="${esc(p.hi?.department || "")}"
            placeholder="हिंदी विभाग"
          >
        ...
        <label class="span-2">
          ...
          <textarea
            data-project-hi="description"
            placeholder="हिंदी में विवरण"
          >${esc(p.hi?.description || "")}</textarea>
...
function renderTeam(){
  ...
  $("teamForms").innerHTML =
    ...
    <article
      class="admin-card team-admin-row"
      data-team-index="${i}"
    >
      ...
      <div class="row-head">
        ...
        <button class="mini-btn danger delete-team">
          Delete Member
        </button>
      ...
      <div class="form-grid">
        ...
        <label class="span-2">
          ...
          <textarea
            data-team-hi="responsibilities"
            placeholder="हिंदी में जिम्मेदारियाँ"
          >${esc(t.hi?.responsibilities || "")}</textarea>
        </label>
...
function renderHindiMainContent(){
  ...
  /*
   * अगर HTML में ये containers मौजूद हैं,
   * तो Hindi fields automatically दिखाई जाएंगी।
   */
  ...
  box.innerHTML = `
    ...
    <div class="admin-card">
      ...
      <p>
        यहाँ Hindi version डालें।
        Website पर Hindi चुनने पर यही text दिखाई देगा।
      </p>
      ...
      <div class="form-grid">
        ...
        <label>
          ...
          <input
            data-hi-setting="homepage.eyebrow"
            value="${esc(homepage.hi?.eyebrow || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="homepage.title"
            value="${esc(homepage.hi?.title || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="homepage.accent"
            value="${esc(homepage.hi?.accent || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="about.eyebrow"
            value="${esc(about.hi?.eyebrow || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="about.title"
            value="${esc(about.hi?.title || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="about.accent"
            value="${esc(about.hi?.accent || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="services.eyebrow"
            value="${esc(services.hi?.eyebrow || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="services.title"
            value="${esc(services.hi?.title || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="services.accent"
            value="${esc(services.hi?.accent || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="contact.eyebrow"
            value="${esc(contact.hi?.eyebrow || "")}"
          >
        </label>
        ...
        <label>
          ...
          <input
            data-hi-setting="contact.title"
            value="${esc(contact.hi?.title || "")}"
          >
        </label>
  ...
  $(id).innerHTML =
    ...
    >
      ...
      <div class="repeat-title">
        ...
        <b>
          ${type==="about" ? "About Card" : "Service"}
          ${i+1}
        </b>

        <button class="mini-btn danger delete-repeat">
          Remove
        </button>
      ...
      <label>
        ...
        <input
          data-repeat-hi="title"
          value="${esc(c.hi?.title || "")}"
  ...
  $("socialLinks").innerHTML =
    (data.settings.contact.socials || [])
      ...
      >
        ...
        <button class="mini-btn danger delete-social">
          Remove
        </button>
    ...
    Object.keys(labels)
      ...
      <label class="toggle-card">
        ...
        <input
          type="checkbox"
          data-section="${k}"
          ${data.settings.sections[k] ? "checked" : ""}
        >
...
function renderFeatured(){
  ...
  $("featuredProject").innerHTML =
    data.projects.map(p=>`
      ...
      <option
        value="${esc(p.id)}"
        ${p.id===data.settings.featuredProjectId
          ? "selected"
          : ""}
      >
  ...
  $("galleryForms").innerHTML =
    (data.settings.gallery || [])
      ...
      >
        ...
        <button class="mini-btn danger delete-gallery">
          Remove Photo
        </button>
...
document.addEventListener("input",e=>{
  ...
  if(el.matches("[data-hi-setting]")){
    ...
    setPath(
      data.settings,
      el.dataset.hiSetting.split(".").slice(0,-1).join(".") + ".hi." +
      el.dataset.hiSetting.split(".").pop(),
      el.value
    );
  ...
  const pr =
    el.closest("[data-project-index]");


  if(
    pr &&
    el.matches("[data-project]")
  ){

    const p =
      data.projects[
        +pr.dataset.projectIndex
      ];


    p[el.dataset.project] =
      el.value;
  ...
  const tr =
    el.closest("[data-team-index]");


  if(
    tr &&
    el.matches("[data-team]")
  ){

    data.team[
      +tr.dataset.teamIndex
    ][el.dataset.team] =
      el.value;
  ...
  const rr =
    el.closest("[data-repeat]");


  if(
    rr &&
    el.matches("[data-repeat-field]")
  ){
  ...
  const sr =
    el.closest("[data-social-index]");


  if(
    sr &&
    el.matches("[data-social]")
  ){

    data.settings.contact.socials[
      +sr.dataset.socialIndex
    ][
      el.dataset.social
    ] =
      el.value;
  ...
  const gr =
    el.closest("[data-gallery-index]");


  if(
    gr &&
    el.matches("[data-gallery]")
  ){

    data.settings.gallery[
      +gr.dataset.galleryIndex
    ][
      el.dataset.gallery
    ] =
      el.value;
...
async function uploadImage(
  ...
  if(!sb){
    ...
    alert(
      "Supabase is required for photo upload."
    );
...
document.addEventListener("click",e=>{
  ...
  if(
    e.target.matches(".delete-project")
  ){
  ...
  if(
    e.target.matches(".delete-repeat")
  ){
  ...
  if(
    e.target.matches(".delete-social")
  ){
  ...
  if(
    e.target.matches(".delete-gallery")
  ){
...
async function saveAll(){
  ...
  /*
   * Hindi fields को सुरक्षित रखते हुए
   * पूरा data Supabase में save होगा।
   */
