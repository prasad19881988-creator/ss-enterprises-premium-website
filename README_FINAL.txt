...
HR LETTERS UPDATE
1. Run HR_LETTERS_MIGRATION.sql in Supabase SQL Editor before using Save Letter for Warning/Termination.
2. Upload/replace admin.html and admin.js in the existing project and deploy normally. No employee name is hard-coded; the selected Staff record supplies the name/code/designation/address.
3. Warning and Termination letters are saved in the existing letters table and shown in Letter History.
4. TL/District Coordinator performance basis is generated from designation and is treated as a performance-linked component subject to the Offer/Joining Letter, Company policy and applicable law.
