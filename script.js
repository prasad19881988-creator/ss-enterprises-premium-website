...
(function(){
  ...
  form.addEventListener("submit",async function(e){e.preventDefault();
    ...
    const obj={full_name:document.getElementById("ja_name").value.trim(),mobile:document.getElementById("ja_mobile").value.trim(),email:document.getElementById("ja_email").value.trim(),applied_post:document.getElementById("ja_post").value,qualification:document.getElementById("ja_qualification").value.trim(),experience:document.getElementById("ja_experience").value.trim(),address:document.getElementById("ja_address").value.trim(),photo_url:document.getElementById("ja_photo").value.trim(),resume_url:document.getElementById("ja_resume").value.trim(),message:document.getElementById("ja_message").value.trim(),status:"new"};
